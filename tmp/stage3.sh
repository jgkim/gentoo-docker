...
busybox echo "Downloading the stage tarball..."

busybox wget -q "${base_url}/${latest_stage3}" || die "Could not download the stage tarball"
...
busybox echo "Installing the stage tarball..."
